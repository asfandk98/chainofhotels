        ...
        <div className="w-full max-w-xl flex flex-col items-center">
          <div className="text-center mb-12">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant max-w-sm mx-auto">
              Sign in to complete your booking and access your saved stays.
            </p>
          </div>
            ...
            <div className="space-y-2">
              ...
              <div className="text-right">
                <Link
                  ...
                  className="font-label-caps text-[10px] text-secondary/70 hover:text-secondary transition-colors"
                >
                  FORGOT PASSWORD?
                </Link>
              </div>
          ...
          <div className="mt-12 text-center">
            <p className="font-body-md text-on-surface/60">
              ...
              <Link
                href="/register"
                className="text-secondary underline underline-offset-8 decoration-secondary/30 hover:decoration-secondary transition-all"
              >
                Sign up
              </Link>
            </p>
